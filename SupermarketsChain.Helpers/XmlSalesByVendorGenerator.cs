namespace SupermarketsChain.Helpers
{
    ...
    public class XmlSalesByVendorGenerator
    {
        public static void Generate(string startDate, string endDate)
        {
        ...
        public static void Generate(DateTime startDate, DateTime endDate)
        {
        ...
        private static void WriteSaleToVendor(
            XmlWriter writer, DateTime date, decimal totalSum)
        {
